...
18 March 2024: The code here is mostly unused. Its only used for batching texts to pass into
    retrieval_models.embedding_models.ContextualSentenceEmbedder's encode method
"""
import codecs
import json
import sys
